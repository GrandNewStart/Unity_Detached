        ...
        if (Input.GetKeyDown(KeyCode.Q))
        {
            ...
            if (leftPlugged || rightPlugged)
            {
                ...
                if (!activated)
                {
                    ...
                    if ((leftPlugged && leftHand.GetControl()) ||
                        (rightPlugged && rightHand.GetControl()))
                    {
                        activated = true;
                        toggle = true;
            ...
            else
            {
                ...
                if (leftHandAround && !leftPlugged && leftHand.GetControl())
                {
                    leftPlugged = true;
                    leftHand.OnPlugIn();
                    return;
                }
                if (rightHandAround && !rightPlugged && rightHand.GetControl())
                {
                    rightPlugged = true;
                    rightHand.OnPlugIn();
                    return;
